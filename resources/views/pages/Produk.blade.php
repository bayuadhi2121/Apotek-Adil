                    ...
                    <div class="col-md-4">
                        <div class="card mb-4" style="width: auto">
                            ...
                            <div class="card-body" style="margin-left: -1rem;">
                                ...
                                <a href="#">
                                    <p class="store mb-2" style="font-family:'Poppins',sans-serif; font-size: 14px; font-weight: 500;">test</p>
                                </a>
                                <p class="card-text mb-2" style="color: #3682f4; font-size: 18px; font-family: 'Montserrat', sans-serif; font-weight: 700">
                                    <s class="text-muted" style="font-size: 16px; font-family: 'Montserrat', sans-serif; font-weight: 600"></s> Rp 1000000
                                </p>
                                ...
                                <form action="" class="" method="POST">
                                    ...
                                    <a type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="View details" href="" class="view btn btn-outline-primary mt-3"><span class="iconify" data-icon="bi:eye" data-inline="false" style="font-size: 20px; margin: 1px; align-self: center;"></span></a>
                                </form>
                            </div>
                        </div>
                    </div>
